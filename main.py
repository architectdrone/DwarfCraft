...
def parser_init():
    ...
    general.add_argument("--full_reset", action='store_true', help = "Delete everything from bedrock to build limit, in the specified region. For annoying things outside of SIZE's y range.")
    
    ores = parser.add_argument_group("ORES")
    ores.add_argument("--skip_ores", action='store_true', help="Skip placing ore.")
    ores.add_argument("--ore_pockets_per_chunk", type=int, default=15, help="Approximately how many ore pockets should generate in a 16x16x16 area.")
    ores.add_argument("--ore_pocket_size", type=int, default=5, help="Base ore pocket size. This is the size of an ore pocket at the exact diff it is specified at.")
    
    caves = parser.add_argument_group("CAVES")
    caves.add_argument("--skip_caves", action="store_true", help="Skip cave generation.")
    caves.add_argument("--cave_fill_cube", type=int, default=32, metavar = "N", help="One cave should be located in each NxNxN area.")
    caves.add_argument("--cave_length", type=int, default=1000, help="The length of a cave.")
    caves.add_argument("--cave_max_size", type=int, default=10, help="Maximum size of a cave.")
    caves.add_argument("--cave_min_size", type=int, default=2, help="Minimum size of a cave.")
    ...
    lava_pools.add_argument("--lava_pool_spawn_chance", type=float, default=0.99, help="Spawn chance for lava pools in the threshold")
    lava_pools.add_argument("--lava_pool_punishment_factor", type=int, default=4, help="Spawn rates are 'punished' at higher altitudes. Increase this to increase the punishment factor. Conversely, you can set it 0 to do away with punishments, but, if you have fill mode on, I wouldn't reccomend that.")
    lava_pools.add_argument("--lava_pool_fill", type=bool, default=False, help="Use the 'fill' method of generating lava pools.")
    
    glowstone_clusters = parser.add_argument_group("CAVE DECORATION - SPAWNERS", "Spawners become gradually more difficult until you reach the bottom of the world.")
    glowstone_clusters.add_argument("--mob_spawners", type=bool, default=True, help="Whether mob spawners spawn")
    glowstone_clusters.add_argument("--mob_spawner_spawn_chance", type=float, default=0.005, help="Chance of a floor block having a mob spawner. Be careful: Even 5%% was too much.")
    
    bushes = parser.add_argument_group("CAVE DECORATION - BUSHES", "A source of wood underground.")
    bushes.add_argument("--bushes", type=bool, default=True, help="Whether bushes spawn.")
    bushes.add_argument("--bush_melons", type=bool, default=True, help="Whether melons grow on bushes.")
    bushes.add_argument("--bush_melon_spawn_chance", type=float, default=0.05, help="Chance that a particular leaf will be a melon block.")
    bushes.add_argument("--bush_spawn_chance", type=float, default=0.10, help="Chance that any edge will be in a bush cluster.")
    bushes.add_argument("--bush_compression", type=float, default=0.01, help="Chance that an edge in a bush cluster will have a bush")
    bushes.add_argument("--bush_min_size", type=int, default=5, help="")
    bushes.add_argument("--bush_max_size", type=int, default=10, help="")
    
    biomes = parser.add_argument_group("CAVE DECORATION - BIOMES", "Cave theming. There are currently two biomes: organic and stone.")
    biomes.add_argument("--biomes", type=bool, default=True, help="Whether biome decoration occurs.")
    biomes.add_argument("--biome_flower_spawn_chance", type=float, default=0.05, help="")
    biomes.add_argument("--biome_grass_spawn_chance", type=float, default=0.1, help="")
    
    water_pools = parser.add_argument_group("CAVE DECORATION - WATER_POOLS", "A source of water, sand, and sugarcane.")
    water_pools.add_argument("--water_pools", type=bool, default=True, help="Whether water pools spawn")
    water_pools.add_argument("--water_pool_sand_border", type=bool, default=True, help="")
    water_pools.add_argument("--water_pool_spawn_chance", type=float, default=0.05, help="")
    water_pools.add_argument("--water_pool_sugarcane_spawn_chance", type=float, default=0.25, help="")
